...
(* Values are read as chars. *)
val from_file_car: path -> string graph
...
(* Writes a car manufacotring schema into a dot format *)
val export_schema: path -> string graph -> unit
